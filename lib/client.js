...
Client.prototype.setSocket = function(socket) {
  ...
  self.socket.on('data', function(data) {
    ...
    var parsed, packet;
    while (true) {
      parsed = parsePacket(incomingBuffer, self.state, self.isServer, self.packetsToParse, self.compression);
      if (! parsed) break;
      if (parsed.error) {
...
Client.prototype.write = function(packetId, params) {
  ...
  var buffer = createPacketBuffer(packetId, this.state, params, this.isServer, this.compression);
